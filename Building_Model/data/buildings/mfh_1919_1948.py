...
TABULA building: DE.N.MFH.03.Gen.ReEx.001
"""

# ------------------------------------------------------------
# Common data (TABULA + your inputs)
# ------------------------------------------------------------

H_ve_1        = 0.51      # [W/(m²K)]
H_tr_1        = 2.99      # [W/(m²K)]
H_tr_light_1  = 74.48     # [W/K]
H_ve_2        = 0.51      # [W/(m²K)]
H_tr_2        = 0.89      # [W/(m²K)]
H_tr_light_2  = 74.48     # [W/K]
H_ve_3        = 0.43      # [W/(m²K)]
H_tr_3        = 0.47      # [W/(m²K)]
H_tr_light_3  = 37.24     # [W/K]
c_bldg      = 45        # [Wh/m²K]
area_floor  = 350       # [m²]
height_room = 2.5       # [m]
...
mfh_1919_1948_0_soc = {
    ...
    'name': 'mfh_1919_1948_0_soc'
}

mfh_1919_1948_0_soc['T_offset'] = T_offset_base + 2.0   # ≈ 12°C
mfh_1919_1948_0_soc['T_amb_lim'] = 20.0
mfh_1919_1948_0_soc['mdot_hp']   = mdot_hp
...
mfh_1919_1948_0_soc['windows']  = [w_east_0, w_south_0, w_west_0, w_north_0]
mfh_1919_1948_0_soc['position'] = position_hannover


# 1_enev: standard refurbishment
mfh_1919_1948_1_enev = {
    'H_ve': H_ve_2,
    'H_tr': H_tr_2,
    ...
    'area_floor': area_floor,
    'height_room': height_room,
    'name': 'mfh_1919_1948_1_enev'
}

mfh_1919_1948_1_enev['T_offset'] = T_offset_base        # ≈ 10°C
mfh_1919_1948_1_enev['T_amb_lim'] = 20.0
mfh_1919_1948_1_enev['mdot_hp']   = mdot_hp
...
mfh_1919_1948_1_enev['windows']  = [w_east_1, w_south_1, w_west_1, w_north_1]
mfh_1919_1948_1_enev['position'] = position_hannover
...
mfh_1919_1948_2_kfw = {
    ...
    'area_floor': area_floor,
    'height_room': height_room,
    'name': 'mfh_1919_1948_2_kfw'
}

mfh_1919_1948_2_kfw['T_offset'] = T_offset_base - 2.0   # ≈ 8°C
mfh_1919_1948_2_kfw['T_amb_lim'] = 20.0
mfh_1919_1948_2_kfw['mdot_hp']   = mdot_hp
...
mfh_1919_1948_2_kfw['windows']  = [w_east_2, w_south_2, w_west_2, w_north_2]
mfh_1919_1948_2_kfw['position'] = position_hannover
