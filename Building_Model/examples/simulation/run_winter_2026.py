...
def create_plots(df_bl, df_mpc, output_dir):
    ...
    for interval_idx in range(num_intervals):
        ...
        axes[5].plot(hours, df_bl_slice['T_amb'].values, linewidth=1.8, color='#06A77D', label='Outdoor')
        axes[5].set_ylabel('Ambient Temp [°C]', fontsize=10)
        axes[5].set_xlabel('Hour', fontsize=10)
